<div class="nav h-20 w-full pt-4 flex flex-row align-items-center justify-around items-center absolute top-0">
    ...
    <div class="hamburger-menu z-[99999999999]">
      <input id="menu__toggle" type="checkbox" />
      <label class="menu__btn" for="menu__toggle" id="hamburger" onclick="Cekoverflow()">
        <span></span>
      </label>
