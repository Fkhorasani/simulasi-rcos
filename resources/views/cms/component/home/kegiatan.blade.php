<div class="bg-[url('https://rcos.umn.ac.id/front/images/bgr-contact-area.png')]">  
  <div class ="flex justify-left items-center mx-28" data-aos="fade-down">
    <h1 class="text-5xl mt-40 text-black">Kegiatan</h1> 
  </div>
  <div class ="flex justify-center items-center mx-28 my-28">
    <div class="grid lg:grid-cols-2 sm:grid-cols-1">
      <div class="lg:col-span-1 block lg:max-w-8xl my-10 lg:mr-28" data-aos="zoop-in-up">
      ...
      <div class="lg:col-span-1 block lg:max-w-8xl my-10 lg:mr-28" data-aos="zoom-in-up">
      ...
      <div class="lg:col-span-2 block lg:max-w-8xl my-10 lg:mr-28" data-aos="zoom-in-up">
