...
<div id="content" class="bg-slate-300 ml-16 pt-6 transition-all duration-500 min-h-[100dvh] overflow-y-auto">
    <div id="Dashboardlogo" class="w-full px-10 grid grid-cols-2 mt-24">
        <div class="col-span-2 md:col-span-1 flex justify-start">
            ...
            <div class="w-full"> 
                <p class="h-10 font-bold text-lg md:text-2l ml-4 flex items-center">Pengajuan Buku untuk Penelitian - Perpustakaan</p> 
                <p class="h-10 ml-4 min-width: 1536px text-xs md:text-base"><span class="text-sky-700 hover:text-sky-900 transition-all duration-300"><a href="{{ route('dosenDashboard') }}">Dashboard</a></span> &nbsp; / Penelitian Internal / Pengajuan / Pengajuan Buku untuk Penelitian</p>
            </div>
        </div>
            ...
            <table id="example" class="stripe border hover" style="width:100%;">
                <thead class="text-sm md:text-lg">
                    <tr class="border font-bold"></tr>
                        ...
                        <th data-priority="6" class="border"> </th>
                    </tr>
                </thead>
                <tbody class="text-xs md:text-base">
                    <tr class="border">
                        <td class="border">1.</td>
                        <td class="border">Milea</td>
                        <td class="border"> </td>
                    </tr>
                </tbody>
            </table>
