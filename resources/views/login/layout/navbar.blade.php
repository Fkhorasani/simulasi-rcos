...
<div id="sideNav" class="h-screen w-16 bg-slate-800 fixed top-0 transition-all duration-500 z-20">
    ...
    <div class="h-16 w-full pl-4 overflow-hidden cursor-pointer transition-all duration-300 active:bg-slate-600 {{ $currentPage == "dashboard" ? "bg-slate-600" : "hover:bg-slate-700"}}" onclick="window.location.href='{{ route('dosenDashboard') }}'">
    ...
    <div class="w-full overflow-hidden cursor-pointer transition-all duration-300">
        ...
        <div id="sideDropdown" class="max-h-0 opacity-0 overflow-hidden transition-all duration-500">
            <div class="w-56 h-14 flex justify-start items-center pl-7 transition-all duration-500 active:bg-slate-600 {{ $currentPage == "proposalPenelitian" ? "bg-slate-600" : "hover:bg-slate-700"}}" onclick="window.location.href='{{ route('dosenProposalPenelitian') }}'">
            ...
            <div class="w-56 h-14 flex justify-start items-center pl-7 transition-all duration-500 active:bg-slate-600 {{ $currentPage == "listProposalInternal" ? "bg-slate-600" : "hover:bg-slate-700"}}" onclick="window.location.href='{{ route('ListProposalInternal') }}'" >
                <div class="h-full w-7">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-full w-5 text-slate-300" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="w-56 h-14 flex justify-start items-center pl-7 transition-all duration-500 active:bg-slate-600 {{ $currentPage == "pengajuanAnggaran" ? "bg-slate-600" : "hover:bg-slate-700"}}" onclick="window.location.href='{{ route('pengajuanAnggaran') }}'">
                <div class="h-full w-7">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-full w-5 text-slate-300" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="w-56 h-14 flex justify-start items-center pl-7 transition-all duration-500 active:bg-slate-600 {{ $currentPage == "pengajuanPembelian" ? "bg-slate-600" : "hover:bg-slate-700"}}" onclick="window.location.href='{{ route('dosenPengajuanPembelian') }}'">
                <div class="h-full w-7">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-full w-5 text-slate-300" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="w-56 h-14 flex justify-start items-center pl-7 transition-all duration-500 active:bg-slate-600 {{ $currentPage == "pengajuanBuku" ? "bg-slate-600" : "hover:bg-slate-700"}}" onclick="window.location.href='{{ route('pengajuanAnggaran') }}'">
                <div class="h-full w-7">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-full w-5 text-slate-300" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="w-56 h-14 flex justify-start items-center pl-7 transition-all duration-500 active:bg-slate-600 {{ $currentPage == "pemantauanEvaluasiPenelitian" ? "bg-slate-600" : "hover:bg-slate-700"}}"onclick="window.location.href='{{ route('dosenLaporanPemantauan') }}'">
                <div class="h-full w-7">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-full w-5 text-slate-300" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="h-16 w-full pl-4 overflow-hidden cursor-pointer transition-all duration-300 transition-all duration-500 active:bg-slate-600 {{ $currentPage == "penelitianMandiri" ? "bg-slate-600" : "hover:bg-slate-700"}}" onclick="window.location.href='{{ route('dosenPenelitianMandiri') }}'">
        <div class="w-52 h-full flex justify-start items-center">
            <div class="h-10 w-7">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-7 text-slate-300" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd"></path>
    ...
    <div class="h-16 w-full pl-4 overflow-hidden cursor-pointer transition-all duration-300 transition-all duration-500 active:bg-slate-600 {{ $currentPage == "review" ? "bg-slate-600" : "hover:bg-slate-700"}}" onclick="window.location.href='{{ route('dosenReview') }}'">
        <div class="w-52 h-full flex justify-start items-center">
            <div class="h-10 w-7">
    ...
    <div class="h-16 w-full pl-4 overflow-hidden cursor-pointer transition-all duration-300 transition-all duration-500 active:bg-slate-600 {{ $currentPage == "dokumenPendukung" ? "bg-slate-600" : "hover:bg-slate-700"}}" onclick="window.location.href='{{ route('dosenDokumenPendukung') }}'">
        <div class="w-52 h-full flex justify-start items-center">
            <div class="h-10 w-7">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-7 text-slate-300" viewBox="0 0 20 20" fill="currentColor">
