<div class="w-full h-16 bg-white shadow-gray-500 shadow-sm fixed top-0">
    <div class="flex justify-end overflow-x-hidden">
        ...
        <div class="h-16 w-56 flex justify-center items-center border-r border-gray-300 overflow-x-hidden hover:bg-slate-200 transition-all duration-500">
